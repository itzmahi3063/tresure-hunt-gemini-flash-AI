...
export default function App() {
  ...
  // 1. Initial 3D Cover Splash Screen with 0%-100% dynamic loading progress
  if (!splashFinished || loading) {
    return <SplashScreen onFinish={() => setSplashFinished(true)} />;
  }

  // 2. Anti-Cheat: Device Already In Use Detection Screen (matching UI)
  ...
  // 3. Mandatory 3 Community Channels Gate Screen (if not verified yet)
