...
import { Gem, DollarSign, Key, Users, Wallet, ChevronDown } from 'lucide-react';
    ...
    <div className="w-full pt-2.5 px-4 pb-2">
      ...
      <div className="flex items-center justify-between box-3d p-3.5">
        ...
        <button
          ...
          className="btn-3d-gold px-4 py-2 rounded-xl text-xs flex items-center space-x-1.5 font-heading"
        >
          <Wallet size={15} />
