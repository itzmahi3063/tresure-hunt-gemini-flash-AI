        ...
        <div className="flex items-center space-x-1.5 shrink-0">
          <button
            ...
            style={{
              ...
              borderBottom: '3px solid #004777',
              color: '#031726',
              boxShadow: '0 2px 10px rgba(0, 240, 255, 0.45)'
            }}
            className="px-2.5 py-2 rounded-xl text-[11px] font-black tracking-wide uppercase flex items-center space-x-1 active:scale-95 transition-all"
          >
            <PlusCircle size={13} />
            <span>DEPOSIT</span>
          </button>
          ...
          <button
            ...
            className="btn-3d-gold px-2.5 py-2 rounded-xl text-[11px] flex items-center space-x-1 font-heading"
          >
            <Wallet size={13} />
